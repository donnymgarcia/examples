#! /usr/bin/perl -w
## check_mem.pl: Managed by Puppet
#
...
sub print_help () {
    ...
    print_usage();
    print "\n";
    print "-w <MemoryWarn> = Memory usage to activate a warning message (eg: -w 90,25 ) .\n";
    print "-c <MemoryCrit> = Memory usage to activate a critical message (eg: -c 95,50 ).\n";
